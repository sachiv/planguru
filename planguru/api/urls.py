...
urlpatterns = [
    ...
    url(r'^events/$', views.EventList.as_view(), name='eventList'),
    url(r'^events/(?P<user_pk>[0-9]+)/$', views.EventList.as_view(), name='eventList'),
    url(r'^events/(?P<pk>[0-9]+)/detail/$', views.EventDetail.as_view(), name='eventDetail'),
